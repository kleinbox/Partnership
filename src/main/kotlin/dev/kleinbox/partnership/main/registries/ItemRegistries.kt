...
import dev.kleinbox.partnership.main.item.BoatyardItem
import dev.kleinbox.partnership.main.item.Hat
import dev.kleinbox.partnership.main.item.extendable.DescriptivePlaceOnWaterBlockItem
import dev.kleinbox.partnership.main.item.extendable.GenericBoatItem
import dev.kleinbox.partnership.main.item.extendable.GenericDescriptiveBlockItem
...
object ItemRegistries {
    ...
    init {
        ...
        ANCHOR = create(
            ...
            itemSupplier = { properties ->
                dev.kleinbox.partnership.main.item.extendable.DescriptiveBlockItem(
                    BlockRegistries.ANCHOR,
                    properties.stacksTo(1)
                )
            }
        )
